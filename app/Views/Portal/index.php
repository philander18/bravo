...
<form autocomplete="off" action="<?= base_url(); ?>home/portal" method="POST">
    <div class="container-fluid portal">
        <div class="form-portal">
            ...
            <button type="Submit" class="btn-submit btn btn-dark fw-bold border border-2 border-danger">Submit</button>
            <a class="btn-back btn btn-dark fw-bold border border-2 border-danger" href="<?= base_url(); ?>" role="button">Back</a>
        </div>
    </div>
</form>
<?= $this->endSection(); ?>